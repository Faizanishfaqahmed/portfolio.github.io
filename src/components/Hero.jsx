  ...
  return (
    <section className='relative w-full h-screen mx-auto'>
      ...
      flex-row items-start gap-5`}>
        ...
        <div className={`${styles.heroHeadText}text-white mt-28`}><h1>Hi, I'm <span className='text-[#915eff]'>Faizan</span></h1>
    <p className={`${styles.heroSubText} mt-2 text-white-100`}>
I Develope 3D visuals, user<br className='sm:block hidden'/> interfaces, and web applicaitons
    </p>
    </div>
     </div>
     <ComputersCanvas />
